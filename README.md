elastigo
--------
[![Total views](https://sourcegraph.com/api/repos/github.com/LLoyd66/elastigo/counters/views.png)](https://sourcegraph.com/github.com/LLoyd66/elastigo)

[![Build Status][1]][2]

[1]: https://drone.io/github.com/LLoyd66/elastigo/status.png
[2]: https://drone.io/github.com/LLoyd66/elastigo/latest


A Go (Golang) based Elasticsearch client, implements core api for Indexing and searching.   GoDoc http://godoc.org/github.com/LLoyd66/elastigo

To get the Chef based Vagrantfile working, be sure to pull like so::

    # This will pull submodules.
    git clone --recursive git@github.com:LLoyd66/elastigo.git
...
```bash
docker run -d -p 9200:9200 -p 9300:9300 dockerfile/elasticsearch
git clone git@github.com:LLoyd66/elastigo.git
cd elastigo
go get -u ./...
cd core
...
examples:
```go
import "github.com/LLoyd66/elastigo/api"
import "github.com/LLoyd66/elastigo/core"
